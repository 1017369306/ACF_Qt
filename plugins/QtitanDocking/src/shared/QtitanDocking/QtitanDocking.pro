TEMPLATE = lib
python:TARGET = Python.QtitanDocking
else:TARGET = QtitanDocking
...
QMAKE_TARGET_PRODUCT = QtitanDocking
QMAKE_TARGET_DESCRIPTION = QtitanDocking user interface component for Qt.C++
